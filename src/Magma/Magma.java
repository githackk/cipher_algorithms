...
public class Magma {
    public static void main() {
        System.out.println("Магма");
        Scanner scanner = new Scanner(System.in);
        System.out.println("Введите текст:");
        String text = scanner.nextLine();
        Magma magma = new Magma(text);
        System.out.println("Зашифрованный текст:" + magma.encode());
        System.out.println("Расшифрованный текст:" + magma.decode());
    }
    ...
    public String encode() {// функция зашифрования
        //разбиение 256 бит основного ключа на 32 32-битных подключей
